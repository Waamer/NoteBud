  ...
  return (<>
    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-4 pb-4 pt-20 sm:pt-28">
      <div className="flex flex-col lg:flex-row-reverse border-2 rounded-lg">
          <div className="-z-40 absolute inset-x-0 m-auto mt-24 lg:mt-10 h-80 max-w-5xl bg-gradient-to-tr from-rose-400 via-rose-600 dark:via-rose-900 to-[#b061ff] dark:to-[#C084FC] blur-[118px]"></div>
