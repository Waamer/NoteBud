...
export function NotePicker() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && notesQuery) {
      const fetchedNotes = notesQuery.map(note => ({ label: note.title.substring(0, 10), link: '/dashboard/notes/' + note._id }));
